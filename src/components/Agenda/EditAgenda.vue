<template>
  <main>
    ...
    <form class="edit-agenda__form grid grid-cols-3 gap-4">
...
<style>
.edit-agenda__form .jds-popover,
.edit-agenda__form .jds-date-input {
  width: 100%;
}
.edit-agenda__form .jds-form-control-label {
  margin-bottom: 4px !important;
}
.edit-agenda__form .jds-select,
.edit-agenda__form .jds-popover__activator,
.edit-agenda__form .jds-input-text {
  width: 100% !important;
}
.edit-agenda__form .jds-text-area__input-wrapper > textarea {
  border: 1px solid #9E9E9E;
}
.edit-agenda__form .jds-text-area__input-wrapper > textarea:hover {
  border: 1px solid #16a34a;
}
.edit-agenda__form .jds-popover__content {
  background-color: white;
  z-index: 10 !important;
}
.edit-agenda__form .jds-calendar {
  max-width: none !important;
}
.edit-agenda__form .jds-calendar .jds-calendar__list-of-days,
.edit-agenda__form .jds-calendar .jds-calendar__days {
